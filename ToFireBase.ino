...
#define HOSTFIREBASE "mxhacksv.firebaseio" // Host o url de Firebase
#define LOC_PRECISION 7 // Precisión de latitud y longitud
//const char* ssid = "MotoV";
//const char* password = "pooe2018";
//
const char* ssid = "mxhacks_esquina1";
const char* password = "1820hack";
...
byte mac[6];
String macStr = "";
String nombreComun = "Tarjeta de Seguridad";
...
/*  while (WiFi.status() != WL_CONNECTED) {
  ...
  Serial.print("MAC Tarjeta de Seguridad: ");
